...
public class CrowdConstant {
	...
	//用户接收验证码并存入redis时   在redis中保存用的前缀
	//后缀 使用用户接受验证码的手机号进行区分。如：键：RANDOM_CODE_18580865040     验证码值：6834
	public static final String REDIS_RANDOM_CODE_PREFIX = "RANDOM_CODE_";

	//发布项目时，初始化项目ProjectVO存入redis时使用的键  后缀：UUID.randomUUID().toString().replaceAll("-", "")
	...
	public static final String MESSAGE_RANDOM_CODE_LENGTH_INVALID = "验证码不符合要求！";
